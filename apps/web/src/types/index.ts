...
export type ProductPaginator = PaginatorInfo<Product>

export type CategoryPaginator = PaginatorInfo<Category>

export type ShopPaginator = PaginatorInfo<Shop>

export type AuthorPaginator = PaginatorInfo<Author>

export type ManufacturerPaginator = PaginatorInfo<Manufacturer>

export type CouponPaginator = PaginatorInfo<Coupon>

export type TagPaginator = PaginatorInfo<Tag>

export type OrderPaginator = PaginatorInfo<Order>

export type OrderStatusPaginator = PaginatorInfo<OrderStatus>

export type RefundPaginator = PaginatorInfo<Refund>

export type DownloadableFilePaginator = PaginatorInfo<DownloadableFile>
